...
<html>
<head>
  <link rel="apple-touch-icon" sizes="76x76" href="resources/css/hostcssimg/apple-icon.png">
  <link rel="icon" type="image/png" href="resources/css/hostcssimg/favicon.png">
  ...
  <!-- CSS Files -->
  <link href="resources/css/hostcss/css/material-dashboard.min.css?v=2.1.0" rel="stylesheet" />
  ...
  <div class="fixed-plugin">
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="button-container">
          <a href="http://demos.creative-tim.com/material-dashboard/docs/2.0/getting-started/introduction.html" target="_blank" class="btn btn-default btn-block">
            View Documentation
          </a>
        </li>
